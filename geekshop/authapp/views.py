...
from adminapp.mixin import BaseClassContextMixin, AuthorisationDispatchMixin
...
class RegisterView(FormView, BaseClassContextMixin):
    ...
    def send_verify_link(self, user):
        ...
        subject = f'Для активации учетной записи {user.username} пройдите по ссылкe'
...
class ProfileFormView(UpdateView, BaseClassContextMixin, AuthorisationDispatchMixin):
